...
import {GrDashboard,  RiStethoscopeLine, LuUser2, PiWheelchairFill, FaRegComment,GrSettingsOption} from '../assets/icons/vander'
            ...
            <nav id="sidebar" className={manuClass}>
                <SimpleBar className="sidebar-content" data-simplebar style={{height:'calc(100% - 60px)'}}>
                    ...
                    <ul className="sidebar-menu">
                        ...
                        <li className={`${manu === "Settings" || "" ? "active" : ""} ms-0`}><Link to="/Settings"><GrSettingsOption className="me-2 d-inline-block mb-0 icon"/>Settings</Link></li>
